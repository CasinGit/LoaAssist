...
use dotenv::dotenv;
use state::app_state::{get_app_data_dir, init_state, load_state};
...
use window_utils::auto_focus_shift::start_mouse_tracking;
...
pub fn run() {
    ...
    tauri::Builder::default()
        .setup(|app| {
            ...
            let dock_manager = Arc::new(DockManager::new());
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            state::app_state::get_gold,                        // * Get Gold Fn
            state::app_state::set_gold,                        // * Set Gold Fn
            state::app_state::increment_gold,                  // * Increment Gold Fn
            state::app_state::decrement_gold,                  // * Decrement Gold Fn
            state::app_state::get_user_settings,               // * Get User Settings Fn
            state::app_state::set_user_settings,               // * Set User Settings Fn
            state::app_state::add_task,                        // // Add Task Fn
            state::app_state::get_position,                    // * Get Window Position
            state::app_state::set_position,                    // * Set Window Position
